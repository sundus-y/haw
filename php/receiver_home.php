        ...
        <div id="container">
            ...
            <div id="containt">
                ...
                <div id="right_containt">
                    ...
                    ?>
                    <h2 id="table_title">New Transactions</h2>
                    <table border="1">
                        <tr id="table_header">
                            <td> ID </td>
                            <td> Sender Name </td>
...
<?php
$query = "SELECT * FROM transactions WHERE status = 1 ORDER BY DATE DESC, STATUS ASC, ID DESC";
$result = $con->query($query);

if ($result->num_rows == 0) {
    echo "<tr> <td colspan='9' style='text-align:center'> <h3> No New Transaction </h3> </td> </tr>";
} else {
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<td>" . $row['DATE'] . "</td>";
        echo "<td>";
        echo "<form action = 'receiver_view_transaction.php' method = 'POST'>";
...
<?php
$query = "SELECT * FROM transactions WHERE status = 2 OR status = 3 OR status = 6 ORDER BY DATE DESC, STATUS ASC, ID DESC";
$result = $con->query($query);
